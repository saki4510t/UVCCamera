...
public class UVCCameraHandler extends AbstractUVCCameraHandler {
	 ...
	 */
	public static final UVCCameraHandler createHandler(
			final Activity parent, final CameraViewInterface cameraView, final int width,
			final int height, final int format, final float bandwidthFactor) {

		return createHandler(parent, cameraView, 1, width, height, format,
				bandwidthFactor);
	}
	...
	public static final UVCCameraHandler createHandler(
		...
		final CameraThread thread = new CameraThread(UVCCameraHandler.class, parent, cameraView,
				encoderType, width, height, format, bandwidthFactor);
		thread.start();
