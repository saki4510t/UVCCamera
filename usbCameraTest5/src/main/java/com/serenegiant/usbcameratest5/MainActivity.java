...
public final class MainActivity extends BaseActivity implements CameraDialog.CameraDialogParent {
	...
	private final OnDeviceConnectListener mOnDeviceConnectListener = new OnDeviceConnectListener() {
		...
		public void onDisconnect(final UsbDevice device, final UsbControlBlock ctrlBlock) {
			if (DEBUG) Log.w(TAG, "onDisconnect:");
			if (mCameraHandler != null) {
				mCameraHandler.close();
				setCameraButton(false);
			}
...
//				Log.w(TAG, "CameraThread#finalize");
//				super.finalize();
//			}
//
//			public AbstractUVCCameraHandler getHandler() {
//				if (DEBUG) Log.w(TAG_THREAD, "getHandler:");
//				synchronized (mSync) {
//					if (mHandler == null)
//					try {
//						mSync.wait();
...
//				if (DEBUG) Log.w(TAG_THREAD, "handleOpen:");
//				handleClose();
//				mUVCCamera = new UVCCamera();
//				mUVCCamera.open(ctrlBlock);
//				if (DEBUG) Log.w(TAG, "supportedSize:" + mUVCCamera.getSupportedSize());
//			}
//
//			public void handleClose() {
//				if (DEBUG) Log.w(TAG_THREAD, "handleClose:");
//				handleStopRecording();
//				if (mUVCCamera != null) {
...
//				if (DEBUG) Log.w(TAG_THREAD, "handleStartPreview:");
...
//				if (DEBUG) Log.w(TAG_THREAD, "handleStopPreview:");
//				if (mUVCCamera != null) {
//					mUVCCamera.stopPreview();
//				}
//				synchronized (mSync) {
...
//				if (DEBUG) Log.w(TAG_THREAD, "handleCaptureStill:");
...
//				if (DEBUG) Log.w(TAG_THREAD, "handleStartRecording:");
//				try {
...
//				if (DEBUG) Log.w(TAG_THREAD, "handleStopRecording:mMuxer=" + mMuxer);
//				mVideoEncoder = null;
//				if (mMuxer != null) {
...
//				if (DEBUG) Log.w(TAG_THREAD, "handleUpdateMedia:path=" + path);
//				final MainActivity parent = mWeakParent.get();
//				if (parent != null && parent.getApplicationContext() != null) {
//					try {
//						if (DEBUG) Log.w(TAG, "MediaScannerConnection#scanFile");
...
//				if (DEBUG) Log.w(TAG_THREAD, "handleRelease:");
// 				handleClose();
//				if (!mIsRecording)
...
//					if (DEBUG) Log.w(TAG, "onPrepared:encoder=" + encoder);
//					mIsRecording = true;
//				}
//
//				@Override
//				public void onStopped(final MediaEncoder encoder) {
//					if (DEBUG) Log.w(TAG_THREAD, "onStopped:encoder=" + encoder);
